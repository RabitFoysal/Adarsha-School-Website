  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">আমাদের কর্মকর্তা ও কর্মচারীবৃন্দ</h2>
        <div className="w-24 h-1 bg-blue-600 mx-auto mt-4 rounded"></div>
        <p className="text-gray-600 mt-4">{schoolInfo.name}-এর দক্ষ কর্মকর্তা ও কর্মচারী সমূহের তালিকা</p>
      </div>
